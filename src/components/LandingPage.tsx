      ...
      <section className="py-20 px-6 border-t border-[#f0f0f0] dark:border-[#1a1a1a]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {["ChatGPT", "Claude", "Gemini", "Copilot", "Perplexity", "Grok"].map((name) => (
              <div
                key={name}
                className="px-5 py-2.5 rounded-xl border border-[#e5e7eb] dark:border-[#333] text-xs font-medium text-[#6b7280] dark:text-[#9ca3af] bg-[#fafafa] dark:bg-[#111]"
              >
                {name}
              </div>
            ))}

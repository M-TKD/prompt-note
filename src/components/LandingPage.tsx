        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-3 gap-3 max-w-md mx-auto">
            {[
              ...
              { name: "Copilot", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M23.922 12.397c-.04.53-.207 1.064-.535 1.62-.862 1.46-2.554 2.94-4.326 4.028v1.603a.785.785 0 01-.343.653l-2.03 1.383a.81.81 0 01-.911-.003l-1.61-1.12a.797.797 0 01-.34-.654v-.568l-.837.46-.837-.46v.569a.797.797 0 01-.34.653l-1.61 1.12a.81.81 0 01-.911.003l-2.03-1.383a.785.785 0 01-.343-.653v-1.603c-1.772-1.088-3.464-2.569-4.326-4.028-.328-.556-.495-1.09-.535-1.62a2.46 2.46 0 01.27-1.374c.353-.66.978-1.166 1.774-1.473a4.52 4.52 0 011.56-.31c.456-.013.87.047 1.196.118L6.8 5.35a2.04 2.04 0 011.065-1.245L11.418 2.1a1.332 1.332 0 011.164 0l3.553 2.005c.49.277.87.73 1.065 1.245l.852 4.008c.326-.071.74-.131 1.196-.118.542.016 1.08.117 1.56.31.796.307 1.421.812 1.774 1.473a2.46 2.46 0 01.34 1.374z" fill="url(#cp-grad)"/><path d="M18.138 11.35c-.306-.084-.646-.149-1.005-.16a3.61 3.61 0 00-1.204.174l-1.18-5.55a1.23 1.23 0 00-.648-.757L10.548 3.05a.524.524 0 00-.46 0L6.536 5.057a1.23 1.23 0 00-.648.757l-1.18 5.55a3.61 3.61 0 00-1.204-.175c-.36.011-.7.076-1.005.16.383-.278.89-.517 1.585-.42.495.068.963.328 1.37.648l.104-.49a.813.813 0 01.426-.546l4.35-2.457a.384.384 0 01.345-.003l4.393 2.46a.813.813 0 01.428.547l.103.489c.408-.32.876-.58 1.37-.649.697-.096 1.203.143 1.586.42z" fill="#fff"/><defs><linearGradient id="cp-grad" x1="0" x2="24" y1="2" y2="22" gradientUnits="userSpaceOnUse"><stop stopColor="#70C8B8"/><stop offset=".25" stopColor="#3BA0DB"/><stop offset=".5" stopColor="#8B6CC1"/><stop offset=".75" stopColor="#C3548D"/><stop offset="1" stopColor="#E37856"/></linearGradient></defs></svg> },

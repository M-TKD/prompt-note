    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-[#1a1a1a] dark:text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md border-b border-[#f0f0f0] dark:border-[#1a1a1a]">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center">
            <img src="/logo-horizontal.png" alt="PromptNotes" className="h-9 w-auto dark:invert" />
          </div>
      ...
      <section className="py-20 px-6 bg-[#fafafa] dark:bg-[#0d0d0d] border-t border-[#f0f0f0] dark:border-[#1a1a1a]">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-xl sm:text-3xl font-bold tracking-tight text-center mb-16">
            3ステップで、
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-md mx-auto">
            {[
              ...
              <div
                key={ai.name}
                className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-3 sm:py-3.5 rounded-xl border border-[#e5e7eb] dark:border-[#333] bg-[#fafafa] dark:bg-[#111] hover:border-[#d1d5db] dark:hover:border-[#444] transition-colors"
              >
                <div className="w-6 h-6 flex items-center justify-center shrink-0">{ai.logo}</div>
                <span className="text-xs sm:text-sm font-medium text-[#404040] dark:text-[#e5e7eb]">{ai.name}</span>
              </div>
            ))}
          </div>
        </div>
